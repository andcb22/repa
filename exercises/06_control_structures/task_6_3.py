        ...
        if command.endswith("allowed vlan"):
            ...
            if vland[0] == 'add':
             #   print("command is ADD")
                print(f" {command} add {','.join(vland[1:])}")
            elif vland[0] == 'del':
             #  print('command is DEL')
               print(f" {command} remove {','.join(vland[1:])}")
            elif vland[0] == 'only':
             #   print('command is ONLY')
                print(f" {command} {','.join(vland[1:])}")
        else:
           print(f" {command}")
