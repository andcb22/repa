...
#split по пробелу, последний элемент, split по запятой, перевести в множество, пересечение и сортировка
result = sorted(list(set(command1.split()[-1].split(','))&set(command2.split()[-1].split(','))))
print(result)